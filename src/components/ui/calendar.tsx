  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_cell:
          "text-muted-foreground rounded-md flex-1 font-bold text-[0.7rem] uppercase tracking-widest text-center",
        row: "flex w-full mt-1.5",
        cell: cn(
          "relative p-0 text-center text-sm focus-within:relative focus-within:z-20 flex-1 h-10",
          "[&:has([aria-selected])]:bg-accent/50 first:[&:has([aria-selected])]:rounded-l-xl last:[&:has([aria-selected])]:rounded-r-xl"
        ),
        day: cn(
          buttonVariants({ variant: "ghost" }),
          "h-10 w-full p-0 font-bold aria-selected:opacity-100 rounded-xl transition-all active:scale-95"
        ),
        ...
        day_today: "bg-secondary text-secondary-foreground ring-2 ring-primary/20",
        day_outside:
